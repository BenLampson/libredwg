...
polyface face decoded fixedtypes, and `DWG_TYPE_SEQEND_r11`. The block entity
section is currently validated
...
remaining R11 entity types REPEAT, ENDREP, LOAD, and JUMP. `_3DLINE` is a
