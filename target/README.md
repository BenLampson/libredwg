...
`DWG_TYPE_VIEWPORT_r11`. This is not full R11/R12 parity yet; unsupported
R11/R12 entity/table coverage must still fail clearly with
...
SEQEND, JUMP, POLYLINE, VERTEX, 3DLINE, and DIMENSION.
```
